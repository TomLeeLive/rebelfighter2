...
INT		CD3DApplication::Init() { return 0; };				//게임 객체 생성, 초기화
void	CD3DApplication::Destroy() { return; };				//게임 객체 소멸
INT		CD3DApplication::GameFrameMove() { return 0; };		//게임 객체 갱신
INT		CD3DApplication::GameRender() { return 0; };		//게임 객체 렌더링
